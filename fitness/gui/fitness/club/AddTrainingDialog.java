...
public class AddTrainingDialog extends JDialog {
    ...
    public AddTrainingDialog(JFrame parent) {
        super(parent, "Записать на тренировку", true);
        
        try {
            List<Trainer> trainers = DatabaseManager.getAllTrainers();
            List<Client> clients = DatabaseManager.getAllClients();
            
            if (trainers.isEmpty() || clients.isEmpty()) {
                JOptionPane.showMessageDialog(this,
                    "Для записи на тренировку необходимо наличие тренеров и клиентов",
                    "Ошибка",
            ...
            okButton.addActionListener(e -> {
                try {
                    ...
                    JOptionPane.showMessageDialog(this,
                        "Ошибка при добавлении тренировки: " + ex.getMessage(),
                        "Ошибка",
                        JOptionPane.ERROR_MESSAGE);
                }
            });
